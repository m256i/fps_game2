...
int gladLoadWGL(HDC hdc) {
  ...
  if (open_wgl()) { status = gladLoadWGLLoader((GLADloadproc)get_proc, hdc); }

  return status;
}

void gladUnloadWGL(void) { close_wgl(); }

static HDC GLADWGLhdc = (HDC)INVALID_HANDLE_VALUE;

static int get_exts(void) { return 1; }

static void free_exts(void) { return; }
...
static int has_ext(const char *ext) {
  ...
  if (wglGetExtensionsStringARB == NULL || GLADWGLhdc == INVALID_HANDLE_VALUE) extensions = wglGetExtensionsStringEXT();
  else extensions = wglGetExtensionsStringARB(GLADWGLhdc);
...
static void load_WGL_AMD_gpu_association(GLADloadproc load) {
  ...
  glad_wglCreateAssociatedContextAttribsAMD =
      (PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC)load("wglCreateAssociatedContextAttribsAMD");
  ...
  glad_wglMakeAssociatedContextCurrentAMD =
      (PFNWGLMAKEASSOCIATEDCONTEXTCURRENTAMDPROC)load("wglMakeAssociatedContextCurrentAMD");
  glad_wglGetCurrentAssociatedContextAMD =
      (PFNWGLGETCURRENTASSOCIATEDCONTEXTAMDPROC)load("wglGetCurrentAssociatedContextAMD");
...
static void load_WGL_I3D_digital_video_control(GLADloadproc load) {
  ...
  glad_wglGetDigitalVideoParametersI3D =
      (PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC)load("wglGetDigitalVideoParametersI3D");
  glad_wglSetDigitalVideoParametersI3D =
      (PFNWGLSETDIGITALVIDEOPARAMETERSI3DPROC)load("wglSetDigitalVideoParametersI3D");
}
...
static void load_WGL_I3D_genlock(GLADloadproc load) {
  ...
  glad_wglQueryGenlockMaxSourceDelayI3D =
      (PFNWGLQUERYGENLOCKMAXSOURCEDELAYI3DPROC)load("wglQueryGenlockMaxSourceDelayI3D");
}
static void load_WGL_I3D_image_buffer(GLADloadproc load) {
  ...
  glad_wglAssociateImageBufferEventsI3D =
      (PFNWGLASSOCIATEIMAGEBUFFEREVENTSI3DPROC)load("wglAssociateImageBufferEventsI3D");
...
static void load_WGL_NV_video_capture(GLADloadproc load) {
  ...
  glad_wglEnumerateVideoCaptureDevicesNV =
      (PFNWGLENUMERATEVIDEOCAPTUREDEVICESNVPROC)load("wglEnumerateVideoCaptureDevicesNV");
...
static void find_coreWGL(HDC hdc) { GLADWGLhdc = hdc; }
