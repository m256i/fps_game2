/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sun May 25 15:45:13 2025.
   ...
   --local-files
   --extensions="GL_ARB_direct_state_access,GL_EXT_bgra,GL_EXT_external_buffer,GL_EXT_memory_object,GL_EXT_memory_object_fd,GL_EXT_memory_object_win32,GL_EXT_semaphore,GL_EXT_semaphore_fd,GL_EXT_semaphore_win32,GL_EXT_texture_compression_s3tc,GL_NV_timeline_semaphore"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D4.6&extensions=GL_ARB_direct_state_access&extensions=GL_EXT_bgra&extensions=GL_EXT_external_buffer&extensions=GL_EXT_memory_object&extensions=GL_EXT_memory_object_fd&extensions=GL_EXT_memory_object_win32&extensions=GL_EXT_semaphore&extensions=GL_EXT_semaphore_fd&extensions=GL_EXT_semaphore_win32&extensions=GL_EXT_texture_compression_s3tc&extensions=GL_NV_timeline_semaphore
*/
...
static void load_GL_VERSION_4_0(GLADloadproc load) {
  ...
  glad_glGetSubroutineUniformLocation = (PFNGLGETSUBROUTINEUNIFORMLOCATIONPROC
  )load("glGetSubroutineUniformLocation");
  glad_glGetSubroutineIndex =
    (PFNGLGETSUBROUTINEINDEXPROC)load("glGetSubroutineIndex");
  glad_glGetActiveSubroutineUniformiv = (PFNGLGETACTIVESUBROUTINEUNIFORMIVPROC
...
static void load_GL_VERSION_4_2(GLADloadproc load) {
  ...
  glad_glGetActiveAtomicCounterBufferiv =
    ...
    )load("glGetActiveAtomicCounterBufferiv");
  ...
  glad_glDrawTransformFeedbackInstanced =
    ...
    )load("glDrawTransformFeedbackInstanced");
...
static void load_GL_VERSION_4_5(GLADloadproc load) {
  ...
  glad_glTransformFeedbackBufferRange = (PFNGLTRANSFORMFEEDBACKBUFFERRANGEPROC
  )load("glTransformFeedbackBufferRange");
  ...
  glad_glNamedFramebufferRenderbuffer = (PFNGLNAMEDFRAMEBUFFERRENDERBUFFERPROC
  )load("glNamedFramebufferRenderbuffer");
  ...
  glad_glNamedFramebufferTextureLayer = (PFNGLNAMEDFRAMEBUFFERTEXTURELAYERPROC
  ...
  glad_glInvalidateNamedFramebufferData =
    ...
    )load("glInvalidateNamedFramebufferData");
  ...
  glad_glGetNamedFramebufferParameteriv =
    ...
    )load("glGetNamedFramebufferParameteriv");
  ...
  )load("glGetCompressedTextureSubImage");
...
static void load_GL_VERSION_4_6(GLADloadproc load) {
  ...
  glad_glMultiDrawArraysIndirectCount = (PFNGLMULTIDRAWARRAYSINDIRECTCOUNTPROC
  )load("glMultiDrawArraysIndirectCount");
...
static void load_GL_EXT_external_buffer(GLADloadproc load) {
  ...
  glad_glNamedBufferStorageExternalEXT = (PFNGLNAMEDBUFFERSTORAGEEXTERNALEXTPROC
  )load("glNamedBufferStorageExternalEXT");
}
static void load_GL_EXT_memory_object(GLADloadproc load) {
  ...
  glad_glGetMemoryObjectParameterivEXT = (PFNGLGETMEMORYOBJECTPARAMETERIVEXTPROC
  )load("glGetMemoryObjectParameterivEXT");
  glad_glTexStorageMem2DEXT =
    (PFNGLTEXSTORAGEMEM2DEXTPROC)load("glTexStorageMem2DEXT");
  glad_glTexStorageMem2DMultisampleEXT = (PFNGLTEXSTORAGEMEM2DMULTISAMPLEEXTPROC
  )load("glTexStorageMem2DMultisampleEXT");
  glad_glTexStorageMem3DEXT =
    (PFNGLTEXSTORAGEMEM3DEXTPROC)load("glTexStorageMem3DEXT");
  glad_glTexStorageMem3DMultisampleEXT = (PFNGLTEXSTORAGEMEM3DMULTISAMPLEEXTPROC
  )load("glTexStorageMem3DMultisampleEXT");
...
static void load_GL_EXT_semaphore(GLADloadproc load) {
  ...
  glad_glGetSemaphoreParameterui64vEXT = (PFNGLGETSEMAPHOREPARAMETERUI64VEXTPROC
  )load("glGetSemaphoreParameterui64vEXT");
...
static void load_GL_EXT_semaphore_win32(GLADloadproc load) {
  ...
  glad_glImportSemaphoreWin32HandleEXT = (PFNGLIMPORTSEMAPHOREWIN32HANDLEEXTPROC
  )load("glImportSemaphoreWin32HandleEXT");
  glad_glImportSemaphoreWin32NameEXT =
    (PFNGLIMPORTSEMAPHOREWIN32NAMEEXTPROC)load("glImportSemaphoreWin32NameEXT");
}
static void load_GL_NV_timeline_semaphore(GLADloadproc load) {
  ...
  glad_glGetSemaphoreParameterivNV =
    (PFNGLGETSEMAPHOREPARAMETERIVNVPROC)load("glGetSemaphoreParameterivNV");
}
