...
const char *event_id_to_name(unsigned id) {
  switch (id) {
  case 0x0023:
    return "AdapterAllocation_DCStart";
  case 0x0021:
    return "AdapterAllocation_Start";
  case 0x0022:
    return "AdapterAllocation_Stop";
  case 0x01f5:
    return "BlitCancel_Info";
  case 0x00a6:
    return "Blit_Info";
  case 0x0020:
    return "Context_DCStart";
  case 0x001e:
    return "Context_Start";
  case 0x001f:
    return "Context_Stop";
  case 0x001d:
    return "Device_DCStart";
  case 0x001b:
    return "Device_Start";
  case 0x001c:
    return "Device_Stop";
  case 0x00b1:
    return "DmaPacket_Info";
  case 0x01c2:
    return "DmaPacket_Info_2";
  case 0x01c3:
    return "DmaPacket_Info_3";
  case 0x00af:
    return "DmaPacket_Start";
  case 0x00fc:
    return "FlipMultiPlaneOverlay_Info";
  case 0x00a8:
    return "Flip_Info";
  case 0x017e:
    return "HSyncDPCMultiPlane_Info";
  case 0x01a8:
    return "HwQueue_DCStart";
  case 0x01a6:
    return "HwQueue_Start";
  case 0x010a:
    return "IndependentFlip_Info";
  case 0x0182:
    return "MMIOFlipMultiPlaneOverlay3_Info";
  case 0x0103:
    return "MMIOFlipMultiPlaneOverlay_Info";
  case 0x0074:
    return "MMIOFlip_Info";
  case 0x00fa:
    return "NodeMetadata_Info";
  case 0x00d7:
    return "PresentHistoryDetailed_Start";
  case 0x00ac:
    return "PresentHistory_Info";
  case 0x00ab:
    return "PresentHistory_Start";
  case 0x00b8:
    return "Present_Info";
  case 0x00b2:
    return "QueuePacket_Start";
  case 0x00f4:
    return "QueuePacket_Start_2";
  case 0x00f5:
    return "QueuePacket_Start_3";
  case 0x00b4:
    return "QueuePacket_Stop";
  case 0x0111:
    return "VSyncDPCMultiPlane_Info";
  case 0x0011:
    return "VSyncDPC_Info";
  default:
    return "invalid";
  }
}
...
VOID WINAPI EventRecordCallback(EVENT_RECORD *pEvent) {
  ...
  if (status != ERROR_INSUFFICIENT_BUFFER) {
    wprintf(L"TdhGetEventInformation failed to get buffer size: 0x%x\n",
            status);
    return;
  }
    ...
    for (USHORT i = 0; i < pInfo->TopLevelPropertyCount; ++i) {
      ...
      if (wcscmp(pname, L"VidPnSourceId") == 0) {
        ...
        */
        ...
        status = TdhGetPropertySize(pEvent, 0, NULL, 1, &dataDescriptor,
                                    &propertySize);
        ...
        status = TdhGetProperty(pEvent, 0, NULL, 1, &dataDescriptor,
                                propertySize, (PBYTE)&monitor_index);
