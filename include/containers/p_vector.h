...
#define CREATE_VECTOR_TYPE(TYPE)                                               \
   ...
   */                                                                          \
  static inline vector_##TYPE vector_##TYPE##_create(                          \
    vec_copy_fn       cp,                                                      \
  ...
  static inline void vector_##TYPE##_free(vector_##TYPE *v) {                  \
    ...
    v->size = v->capacity = 0;                                                 \
                                                                               ...
                                                                               \
  /* Iterate begin/end */                                                      \
  static inline TYPE *vector_##TYPE##_begin(const vector_##TYPE *v) {          \
    return v->data;                                                            \
  }                                                                            \
  static inline TYPE *vector_##TYPE##_end(const vector_##TYPE *v) {            \
    return v->data + v->size;                                                  \
  }                                                                            \
                                                                               \
  /* Capacity queries */                                                       \
  static inline size_t vector_##TYPE##_size(const vector_##TYPE *v) {          \
    return v->size;                                                            \
  }                                                                            \
  static inline size_t vector_##TYPE##_capacity(const vector_##TYPE *v) {      \
    return v->capacity;                                                        \
  }                                                                            \
  static inline int vector_##TYPE##_empty(const vector_##TYPE *v) {            \
    return v->size == 0;                                                       \
  }                                                                            \
                                                                               \
  /**                                                                          \
   ...
   */                                                                          \
  static inline int vector_##TYPE##_try_reserve(                               \
    vector_##TYPE *v,                                                          \
    size_t         new_cap                                                     \
  ) {                                                                          \
   ...
   */                                                                          \
  static inline void vector_##TYPE##_reserve(                                  \
    vector_##TYPE *v,                                                          \
    size_t         new_cap                                                     \
  ) {                                                                          \
   ...
   */                                                                          \
  static inline int vector_##TYPE##_push_back(                                 \
    vector_##TYPE *v,                                                          \
    TYPE const    *x                                                           \
  ) {                                                                          \
   ...
   */                                                                          \
  static inline int vector_##TYPE##_insert(                                    \
    vector_##TYPE *v,                                                          \
    size_t         pos,                                                        \
    TYPE const    *x                                                           \
  ) {                                                                          \
   ...
   */                                                                          \
  static inline int vector_##TYPE##_insert_range(                              \
    vector_##TYPE *v,                                                          \
    size_t         pos,                                                        \
    const TYPE    *src,                                                        \
    size_t         n                                                           \
   ...
   */                                                                          \
  static inline int vector_##TYPE##_erase_range(                               \
    vector_##TYPE *v,                                                          \
    size_t         first,                                                      \
    size_t         last                                                        \
  ) {                                                                          \
