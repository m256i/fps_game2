/*
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="c" --spec="gl" --local-files --extensions="GL_ARB_direct_state_access,GL_EXT_bgra,GL_EXT_external_buffer,GL_EXT_memory_object,GL_EXT_memory_object_win32,GL_EXT_semaphore,GL_EXT_semaphore_win32,GL_NV_timeline_semaphore"
    Online:
