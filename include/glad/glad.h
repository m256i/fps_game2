/*
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="c" --spec="gl" --local-files --extensions="GL_EXT_direct_state_access,GL_EXT_memory_object,GL_EXT_memory_object_win32,GL_EXT_semaphore,GL_EXT_semaphore_win32"
    Online:
