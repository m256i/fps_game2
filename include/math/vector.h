...
*/
typedef u0 (*VEC3_ADD_IP_PROC)(vec3 *const, const vec3 *const, const vec3 *const);
static VEC3_ADD_IP_PROC vec3_add_inplace;
typedef u0 (*VEC3_SUB_IP_PROC)(vec3 *const, const vec3 *const, const vec3 *const);
...
typedef u0 (*VEC3_CROSS_IP_PROC)(vec3 *const, const vec3 *const, const vec3 *const);
